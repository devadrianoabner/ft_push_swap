...
SRC_STACK = $(DIR_STACK)stack_build.c \
	$(DIR_STACK)stack_inspect.c \
	$(DIR_STACK)stack_free.c

SRC_NODE = $(DIR_NODE)node_inspect.c

SRC_OPERATIONS = $(DIR_OPERATIONS)push.c \
	$(DIR_OPERATIONS)r_reverse.c \
	$(DIR_OPERATIONS)rotate.c \
	$(DIR_OPERATIONS)swap.c

SRC_METRICS = $(DIR_METRICS)count_op.c \
	$(DIR_METRICS)disorder.c \
	$(DIR_METRICS)benchmark.c \
	$(DIR_METRICS)benchmark_ops.c

SRC_INIT = $(DIR_INIT)init_push_swap.c

SRC_ERROR = $(DIR_ERROR)error.c

SRC_COMMON = $(DIR_COMMON)cost.c \
	$(DIR_COMMON)moves.c \
	$(DIR_COMMON)position.c \
	$(DIR_COMMON)sort_three.c \
	$(DIR_COMMON)return_to_a.c

SRC_SIMPLE = $(DIR_SIMPLE)controller.c \
	$(DIR_SIMPLE)sort_push.c

SRC_STRATEGY = $(DIR_STRATEGY)dispatch.c
